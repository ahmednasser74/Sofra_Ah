...
import com.example.sofra.data.model.userRestaurantReview.Client;
...
public class UserOrdersData {
    ...
    @Expose
    private List<FoodItemData> items = null;
    ...
    public List<FoodItemData> getItems() {
        return items;
    }

    public void setItems(List<FoodItemData> items) {
        this.items = items;
    }
}
